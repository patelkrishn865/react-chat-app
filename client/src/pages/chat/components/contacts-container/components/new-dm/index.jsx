  ...
  return (
    ...
    <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
      <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
        ...
        <div>
            <Input placeholder="Search Contacts" className="rounded-lg p-6 bg-[#2c2e3b] border-none" onChange={e=>serachContacts(e.target.value)} />
        </div>
                ...
                <div className="w-12 h-12 relative">
                 <Avatar className="h-12 w-12 rounded-full overflow-hidden">
                  ...
                  <AvatarImage 
                    ...
                    alt="profile"
                    className="object-center w-full h-full bg-black rounded-full"
                  />
                  ) : (
        ...
        {
            searchedContacts.length <=0 && <div className="flex-1  md:flex md:mt-0 mt-5 flex-col justify-center items-center hidden duration-1000 transition-all">
            <Lottie
