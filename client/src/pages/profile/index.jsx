              ...
              <Avatar className="h-32 w-32 md:w-48 rounded-full overflow-hidden">
                {image ? (
                  <AvatarImage 
                    src={image}
                    alt="profile"
                    className="object-center w-full h-full bg-black"
                  />
                ) : (
                  <div className={`uppercase h-32 w-32 md:h-48 text-5xl border-[1px] flex items-center justify-center rounded-full ${getColor(selectedColor)}`}>
                    {firstName
